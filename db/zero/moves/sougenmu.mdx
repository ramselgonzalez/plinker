...
- Zero does not gain any meter while Sougenmu is active. Because of this, you should try to be thoughtful about when to activate Sougenmu if you only have 1 meter. If they are cornered blocking a <InputBlock>5H</InputBlock>,
...
- He can create a near perfect blockstrings at fullscreen with repeated <InputBlock>236M</InputBlock>.
